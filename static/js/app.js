    ...
    setup() {
        ...
        const loadFiles = async () => {
            try {
                ...
                errorMessage.value = error.response?.data?.error || 'Failed to load files';
            }
        };
        ...
        const shareFile = async (filename) => {
            try {
                ...
                errorMessage.value = error.response?.data?.error || error.message || 'Failed to generate share URL';
                if (shareModal) {
                    shareModal.hide();
                }
            }
        ...
        const shareSelectedFiles = async () => {
            if (selectedFiles.value.length === 0) {
                errorMessage.value = 'Please select files to share';
                return;
            }
            ...
            try {
                ...
                errorMessage.value = error.response?.data?.error || error.message || 'Failed to generate share URLs';
            }
        };
        ...
        const copyAllUrls = async () => {
            ...
            try {
                ...
                successMessage.value = 'All URLs copied to clipboard';
                ...
                errorMessage.value = 'Failed to copy URLs';
            }
        };
